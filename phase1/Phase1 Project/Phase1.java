   ...
   private static final String MAIN_MENU_PROMPT =
    ...
    void showSecondaryMenu() {
        ...
        try{
            ...
            switch (option){
                case 'a' : {
                    System.out.print("â†³ Adding a file...Please Enter a File Name : ");
                    String filename = scanner.next().trim().toLowerCase();
                    addFile(filename);
                    break;
                }
                case 'b' : {
                    System.out.print("â†³ Deleting a file...Please Enter a File Name : ");
                    String filename = scanner.next().trim();
                    deleteFile(filename);
                    break;
                }
                case 'c' : {
                    System.out.print("â†³ Searching a file...Please Enter a File Name : ");
                    String filename = scanner.next().trim();
                    searchFile(filename);
                    break;
                }
